...
class DataLoadPreprocess(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'train':
            ...
            #print('image=',image)  # image= <PIL.Image.Image image mode=RGB size=640x480 at 0x1D15CB6D2A0>
            ...
            elif self.args.dataset == 'NYU' or 'inria' or 'posetrack':
...
class ToTensor(object):
    ...
    def __call__(self, sample):
        ...
        if self.mode == 'train':
            ...
            else: depth = self.to_tensor(depth)
