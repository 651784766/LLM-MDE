...
class PatchTransformerEncoder(nn.Module):
    def __init__(self, in_channels, patch_size=10, embedding_dim=128, num_heads=12):
    ...
    def forward(self, x):
        embeddings = self.embedding_convPxP(x).flatten(2).contiguous()  # .shape = n,c,s = n, embedding_dim, s
